...
func _init() -> void:
	...
	_assert(ui.layout_mode_for_window_width(1439) == "compact", "1439px uses compact layout")
	_assert(ui.layout_mode_for_window_width(1440) == "mid", "1440px starts mid layout")
	_assert(ui.layout_mode_for_window_width(1600) == "mid", "1600px uses mid layout")
	_assert(ui.layout_mode_for_window_width(1679) == "mid", "1679px still uses mid layout")
	_assert(ui.layout_mode_for_window_width(1680) == "wide", "1680px starts wide layout")
